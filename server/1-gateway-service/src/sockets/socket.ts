...
import { IMessageDocument, IOrderDocument, IOrderNotification, winstonLogger } from '@hauxun/jobber-shared';
...
export class SocketIOAppHandler {
  ...
  private orderSocketServiceIOConnections(): void {
    ...
    // custom event
    orderSocketClient.on('order notification', (order: IOrderDocument, notification: IOrderNotification) => {
