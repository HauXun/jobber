...
import { BadRequestError, IAuthDocument, IEmailMessageDetails, isEmail } from '@hauxun/jobber-shared';
...
export async function read(req: Request, res: Response): Promise<void> {
  ...
  const passwordsMatch: boolean = await AuthModel.comparePassword(password, existingUser.password!);
