...
import { IConversationDocument, IMessageDetails, IMessageDocument, lowerCase } from '@hauxun/jobber-shared';
...
export {
    addMessage, createConversation, getConversation, getMessages, getUserConversationList, getUserMessages, markManyMessagesAsRead, markMessageAsRead, updateOffer
};
