...
import { IHitsTotal, IPaginateProps, IQueryList, ISearchResult } from '@hauxun/jobber-shared';
...
export {
    getMoreGigsLikeThis,
    getTopRatedGigsByCategory, gigsSearch,
    gigsSearchByCategory, gigsSearchBySellerId
};
