...
import { IRatingTypes, IReviewMessageDetails, ISellerDocument, ISellerGig } from '@hauxun/jobber-shared';
...
export {
    createGig,
    deleteGig, getGigById,
    getSellerGigs,
    getSellerPausedGigs, seedData, updateActiveGigProp, updateGig, updateGigReview
};
