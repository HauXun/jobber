...
import { ISellerGig, winstonLogger } from '@hauxun/jobber-shared';
...
export {
  addDataToIndex, checkConnection,
  createIndex, deleteIndexedData, elasticSearchClient, getDocumentCount,
  getIndexedData, updateIndexedData
};
