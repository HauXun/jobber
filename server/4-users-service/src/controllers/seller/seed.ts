...
import { BadRequestError, IBuyerDocument, IEducation, IExperience, ISellerDocument } from '@hauxun/jobber-shared';
...
const seed = async (req: Request, res: Response): Promise<void> => {
  ...
  for(let i = 0; i < buyers.length; i++) {
    ...
    const seller: ISellerDocument = {
      ...
      socialLinks: ['https://github.com', 'http://youtube.com', 'https://facebook.com'],
      certificates: [
        {
