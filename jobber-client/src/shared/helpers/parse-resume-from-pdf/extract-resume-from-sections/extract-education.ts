...
import type { ResumeEducation } from '../types/types';
...
const hasDegree = (item: TextItem) => DEGREES.some((degree) => item.text.includes(degree)) || /[ABM][A-Z.]/.test(item.text); // Match AA, B.S., MBA, etc.
