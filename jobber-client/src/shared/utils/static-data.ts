import branchAnimation from 'src/assets/branchAnimation.png';
import branchArt from 'src/assets/branchArt.png';
import branchData from 'src/assets/branchData.png';
import branchDesign from 'src/assets/branchDesign.png';
import branchEcommerce from 'src/assets/branchEcommerce.png';
import branchProgramming from 'src/assets/branchProgramming.png';
import branchTechnology from 'src/assets/branchTechnology.png';
...
export const sliderImages: string[] = [
  ...
  'https://picsum.photos/seed/z1/1400/422',
  'https://picsum.photos/seed/z2/1400/422',
  'https://picsum.photos/seed/z3/1400/422',
  'https://picsum.photos/seed/z4/1400/422'
];
...
export const categories: ICategory[] = [
  ...
  },
  {
    ...
    icon: branchEcommerce
  },
  {
    name: 'Video & Animation',
    icon: branchAnimation
  },
  {
    name: 'Music & Audio',
    icon: branchTechnology
  },
  {
    name: 'Data',
    icon: branchData
