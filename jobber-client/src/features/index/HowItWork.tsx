...
import activityCollaboration from 'src/assets/activityCollaboration.png';
import activityContact from 'src/assets/activityContact.png';
import activityCreated from 'src/assets/activityCreated.png';
import activityFind from 'src/assets/activityFind.png';
      ...
      <div className="px-4 py-8 sm:py-16 lg:px-6">
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-4">
          <div className="text-center">
            <div className="my-0 mx-auto bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-40 lg:w-40">
              <img src={activityCreated} className="text-primary-600 dark:text-primary-300 h-15 w-15 dark:text-sky-400" alt="" />
            </div>
          ...
          <div className="text-center">
            <div className="my-0 mx-auto bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-40 lg:w-40">
              <img src={activityFind} className="text-primary-600 dark:text-primary-300 h-15 w-15" alt="" />
            </div>
          ...
          <div className="text-center">
            <div className="my-0 mx-auto bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-40 lg:w-40">
              <img src={activityContact} className="text-primary-600 dark:text-primary-300 h-15 w-15" alt="" />
            </div>
          ...
          <div className="text-center">
            <div className="my-0 mx-auto bg-primary-100 dark:bg-primary-900 mb-4 flex h-10 w-10 items-center justify-center rounded-full lg:h-40 lg:w-40">
              <img src={activityCollaboration} className="text-primary-600 dark:text-primary-300 h-15 w-15" alt="" />
            </div>
