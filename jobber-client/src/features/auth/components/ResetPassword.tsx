      ...
      <div className="relative mt-24 mx-auto w-11/12 max-w-md rounded-lg bg-white md:w-2/3">
        <div className="relative px-5 py-5">
          ...
          <form className="mt-4 space-y-4 md:space-y-5 lg:mt-5">
            <div>
              <legend className="text-sm font-bold leading-tight tracking-normal text-gray-800">Password</legend>
              <TextInput
                id="password"
                name="password"
                type="password"
            ...
            <div>
              <legend className="text-sm font-bold leading-tight tracking-normal text-gray-800">Confirm Password</legend>
              <TextInput
                id="confirmPassword"
